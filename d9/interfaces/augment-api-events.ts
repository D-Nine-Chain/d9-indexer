...
import type { FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletD9CouncilLockAccountLockState, PalletD9CouncilLockVoteResult, PalletD9NodeVotingValidatorVoteStats, PalletImOnlineSr25519AppSr25519Public, SpConsensusGrandpaAppPublic, SpRuntimeDispatchError } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    councilLock: {
      AccountLocked: AugmentedEvent<ApiType, [AccountId32]>;
      AccountNominatedForLock: AugmentedEvent<ApiType, [AccountId32]>;
      AccountNominatedForUnlock: AugmentedEvent<ApiType, [AccountId32]>;
      AccountUnlocked: AugmentedEvent<ApiType, [AccountId32]>;
      ProposalFeePaid: AugmentedEvent<ApiType, [AccountId32, u128]>;
      VoteEnded: AugmentedEvent<ApiType, [AccountId32, PalletD9CouncilLockVoteResult]>;
      /**
       * voter, proposed account lock state, decision
       **/
      VoteRecorded: AugmentedEvent<ApiType, [AccountId32, AccountId32, PalletD9CouncilLockAccountLockState, bool]>;
      VoteStarted: AugmentedEvent<ApiType, []>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    d9MultiSig: {
       ...
       **/
      ApprovalAdded: AugmentedEvent<ApiType, [AccountId32, AccountId32]>;
      /**
       * remove approval from transaction (multi signature account, approver)
       **/
      ApprovalRemoved: AugmentedEvent<ApiType, [AccountId32, AccountId32]>;
      /**
       * (executor)
       **/
      CallExecuted: AugmentedEvent<ApiType, [U8aFixed]>;
      /**
       * msa set new minimum approvals (multi signature account, new minimum)
       **/
      MinApprovalsChanged: AugmentedEvent<ApiType, [AccountId32, u32]>;
      /**
       * (creator, created)
       **/
      MultiSignatureAccountCreated: AugmentedEvent<ApiType, [AccountId32, AccountId32]>;
      /**
       * (updater, updated)
       **/
      MultiSignatureAccountUpdated: AugmentedEvent<ApiType, [AccountId32, AccountId32]>;
      /**
       * new transaction authors (author, call_id)
       **/
      NewCallAuthored: AugmentedEvent<ApiType, [AccountId32, U8aFixed]>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    imOnline: {
       ...
       **/
      SomeOffline: AugmentedEvent<ApiType, [offline: Vec<ITuple<[AccountId32, PalletD9NodeVotingValidatorVoteStats]>>], { offline: Vec<ITuple<[AccountId32, PalletD9NodeVotingValidatorVoteStats]>> }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
