...
export default {
  ...
  /**
   * Lookup28: sp_weights::weight_v2::Weight
   **/
  ...
  /**
   * Lookup30: pallet_d9_node_voting::structs::ValidatorDelegations<T>
   **/
  ...
  /**
   * Lookup31: pallet_d9_node_voting::pallet::Event<T>
   **/
  ...
  /**
   * Lookup32: pallet_d9_node_voting::pallet::Error<T>
   **/
  PalletD9NodeVotingError: {
    _enum: ['HexDecodeError', 'EmptyDelegationList', 'DelegationListTooLarge', 'DelegatorHasNoVotingCapacity', 'DelegatorHasNoAvailableVotes', 'DelegatorHasInsufficientVotes', 'AttemptingToRemoveMoreVotesThanDelegated', 'CandidateDoesNotExist', 'ErrorGettingNodeMetadata', 'VoterDidntDelegateToThisCandidate', 'NotActiveValidator', 'AtMaximumNumberOfCandidates', 'BurnAmountMustBeGreaterThan100', 'SupporterShareOutOfRange', 'CurrentValidatorCanNotChangeSharePercentage']
  },
  /**
   * Lookup33: pallet_d9_balances::types::AccountData<Balance>
   **/
  ...
  /**
   * Lookup36: pallet_d9_balances::types::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup38: pallet_d9_balances::types::Reasons
   **/
  PalletD9BalancesReasons: {
    _enum: ['Fee', 'Misc', 'All']
  },
  /**
   * Lookup41: pallet_d9_balances::types::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup45: pallet_d9_balances::types::IdAmount<Id, Balance>
   **/
  ...
  /**
   * Lookup48: pallet_d9_balances::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup54: pallet_d9_balances::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup56: pallet_d9_balances::pallet::Error<T, I>
   **/
  PalletD9BalancesError: {
    _enum: ['VestingBalance', 'LiquidityRestrictions', 'InsufficientBalance', 'ExistentialDeposit', 'Expendability', 'ExistingVestingSchedule', 'DeadAccount', 'TooManyReserves', 'TooManyHolds', 'TooManyFreezes']
  },
  /**
   * Lookup57: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup58: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup61: sp_consensus_grandpa::app::Public
   **/
  SpConsensusGrandpaAppPublic: 'SpCoreEd25519Public',
  /**
   * Lookup62: sp_core::ed25519::Public
   **/
  SpCoreEd25519Public: '[u8;32]',
  /**
   * Lookup66: pallet_grandpa::pallet::Call<T>
   **/
  PalletGrandpaCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup67: sp_consensus_grandpa::EquivocationProof<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup69: sp_consensus_grandpa::Equivocation<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup70: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Prevote<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup71: finality_grandpa::Prevote<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup72: sp_consensus_grandpa::app::Signature
   **/
  SpConsensusGrandpaAppSignature: 'SpCoreEd25519Signature',
  /**
   * Lookup73: sp_core::ed25519::Signature
   **/
  SpCoreEd25519Signature: '[u8;64]',
  /**
   * Lookup76: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup77: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup81: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup83: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup86: pallet_multisig::pallet::Call<T>
   **/
  PalletMultisigCall: {
    _enum: {
  ...
  /**
   * Lookup94: pallet_assets::pallet::Call<T, I>
   **/
  PalletAssetsCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup96: pallet_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup97: pallet_contracts::pallet::Call<T>
   **/
  PalletContractsCall: {
    _enum: {
      call_old_weight: {
  ...
  /**
   * Lookup99: pallet_contracts::wasm::Determinism
   **/
  PalletContractsWasmDeterminism: {
    _enum: ['Enforced', 'Relaxed']
  },
  /**
   * Lookup100: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup101: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup102: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup106: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  PalletImOnlineSr25519AppSr25519Signature: 'SpCoreSr25519Signature',
  /**
   * Lookup107: sp_core::sr25519::Signature
   **/
  ...
  /**
   * Lookup109: d9_node_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup111: sp_authority_discovery::app::Public
   **/
  SpAuthorityDiscoveryAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup112: pallet_treasury::pallet::Call<T, I>
   **/
  PalletTreasuryCall: {
    _enum: {
      propose_spend: {
  ...
  /**
   * Lookup115: pallet_multisig::pallet::Event<T>
   **/
  PalletMultisigEvent: {
    _enum: {
      NewMultisig: {
  ...
  /**
   * Lookup117: sp_runtime::DispatchError
   **/
  ...
  /**
   * Lookup118: sp_runtime::ModuleError
   **/
  ...
  /**
   * Lookup120: sp_runtime::TokenError
   **/
  SpRuntimeTokenError: {
  ...
  /**
   * Lookup121: sp_arithmetic::ArithmeticError
   **/
  SpArithmeticArithmeticError: {
    _enum: ['Underflow', 'Overflow', 'DivisionByZero']
  },
  /**
   * Lookup122: sp_runtime::TransactionalError
   **/
  SpRuntimeTransactionalError: {
    _enum: ['LimitReached', 'NoLayer']
  },
  /**
   * Lookup123: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
  ...
  /**
   * Lookup126: frame_system::AccountInfo<Index, pallet_d9_balances::types::AccountData<Balance>>
   **/
  ...
  /**
   * Lookup127: frame_support::dispatch::PerDispatchClass<sp_weights::weight_v2::Weight>
   **/
  ...
  /**
   * Lookup128: sp_runtime::generic::digest::Digest
   **/
  SpRuntimeDigest: {
    logs: 'Vec<SpRuntimeDigestDigestItem>'
  },
  /**
   * Lookup130: sp_runtime::generic::digest::DigestItem
   **/
  ...
  /**
   * Lookup132: frame_system::EventRecord<d9_node_runtime::RuntimeEvent, primitive_types::H256>
   **/
  ...
  /**
   * Lookup134: frame_system::pallet::Event<T>
   **/
  FrameSystemEvent: {
    _enum: {
      ExtrinsicSuccess: {
  ...
  /**
   * Lookup135: frame_support::dispatch::DispatchInfo
   **/
  ...
  /**
   * Lookup136: frame_support::dispatch::DispatchClass
   **/
  FrameSupportDispatchDispatchClass: {
    _enum: ['Normal', 'Operational', 'Mandatory']
  },
  /**
   * Lookup137: frame_support::dispatch::Pays
   **/
  FrameSupportDispatchPays: {
    _enum: ['Yes', 'No']
  },
  /**
   * Lookup138: pallet_transaction_payment::pallet::Event<T>
   **/
  ...
  /**
   * Lookup139: pallet_assets::pallet::Event<T, I>
   **/
  PalletAssetsEvent: {
    _enum: {
      Created: {
  ...
  /**
   * Lookup140: pallet_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup141: pallet_contracts::pallet::Event<T>
   **/
  ...
  /**
   * Lookup142: pallet_im_online::pallet::Event<T>
   **/
  PalletImOnlineEvent: {
    _enum: {
      HeartbeatReceived: {
  ...
  /**
   * Lookup145: pallet_session::pallet::Event
   **/
  PalletSessionEvent: {
    _enum: {
      NewSession: {
  ...
  /**
   * Lookup152: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup153: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup154: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup156: frame_system::limits::BlockLength
   **/
  FrameSystemLimitsBlockLength: {
    max: 'FrameSupportDispatchPerDispatchClassU32'
  },
  /**
   * Lookup157: frame_support::dispatch::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup165: pallet_transaction_payment::Releases
   **/
  PalletTransactionPaymentReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup166: pallet_assets::types::AssetDetails<Balance, sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup167: pallet_assets::types::AssetStatus
   **/
  PalletAssetsAssetStatus: {
    _enum: ['Live', 'Frozen', 'Destroying']
  },
  /**
   * Lookup169: pallet_assets::types::AssetAccount<Balance, DepositBalance, Extra>
   **/
  ...
  /**
   * Lookup170: pallet_assets::types::ExistenceReason<Balance>
   **/
  ...
  /**
   * Lookup172: pallet_assets::types::Approval<Balance, DepositBalance>
   **/
  ...
  /**
   * Lookup173: pallet_assets::types::AssetMetadata<DepositBalance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup175: pallet_assets::pallet::Error<T, I>
   **/
  PalletAssetsError: {
  ...
  /**
   * Lookup179: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup180: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup182: pallet_contracts::wasm::PrefabWasmModule<T>
   **/
  ...
  /**
   * Lookup184: pallet_contracts::wasm::OwnerInfo<T>
   **/
  ...
  /**
   * Lookup185: pallet_contracts::storage::ContractInfo<T>
   **/
  ...
  /**
   * Lookup187: pallet_contracts::storage::DeletionQueueManager<T>
   **/
  ...
  /**
   * Lookup188: pallet_contracts::schedule::Schedule<T>
   **/
  ...
  /**
   * Lookup189: pallet_contracts::schedule::Limits
   **/
  ...
  /**
   * Lookup190: pallet_contracts::schedule::InstructionWeights<T>
   **/
  ...
  /**
   * Lookup191: pallet_contracts::schedule::HostFnWeights<T>
   **/
  ...
  /**
   * Lookup192: pallet_contracts::pallet::Error<T>
   **/
  ...
  /**
   * Lookup197: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup201: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
  ...
  /**
   * Lookup209: pallet_treasury::Proposal<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup213: frame_support::PalletId
   **/
  FrameSupportPalletId: '[u8;8]',
  /**
   * Lookup214: pallet_treasury::pallet::Error<T, I>
   **/
  PalletTreasuryError: {
    _enum: ['InsufficientProposersBalance', 'InvalidIndex', 'TooManyApprovals', 'InsufficientPermission', 'ProposalNotApproved']
  },
  /**
   * Lookup216: sp_runtime::MultiSignature
   **/
  ...
  /**
   * Lookup229: d9_node_runtime::Runtime
   **/
