...
export default {
  ...
  /**
   * Lookup17: pallet_d9_node_voting::types::VotingInterest
   **/
  PalletD9NodeVotingVotingInterest: {
    total: 'Compact<u64>',
    delegated: 'Compact<u64>'
  },
  /**
   * Lookup22: pallet_d9_node_voting::types::ValidatorVoteStats<T>
   **/
  PalletD9NodeVotingValidatorVoteStats: {
  ...
  /**
   * Lookup23: pallet_d9_node_voting::types::NodeMetadataStruct
   **/
  PalletD9NodeVotingNodeMetadataStruct: {
    name: 'Bytes',
    sharingPercent: 'u8',
  ...
  PalletD9NodeVotingCall: {
    _enum: {
      submit_candidacy: {
        candidateMetadata: 'PalletD9NodeVotingNodeMetadataStruct',
      },
      add_voting_interest: {
      ...
      delegate_votes: {
        delegations: 'Vec<PalletD9NodeVotingValidatorDelegations>',
      },
  ...
  /**
   * Lookup29: pallet_d9_node_voting::types::ValidatorDelegations<T>
   **/
  PalletD9NodeVotingValidatorDelegations: {
    candidate: 'AccountId32',
    votes: 'Compact<u64>'
  },
  /**
  ...
  /**
   * Lookup91: pallet_sudo::pallet::Call<T>
   **/
  PalletSudoCall: {
    _enum: {
      sudo: {
  ...
  /**
   * Lookup98: pallet_assets::pallet::Call<T, I>
   **/
  PalletAssetsCall: {
    _enum: {
      create: {
  ...
  /**
   * Lookup100: pallet_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup101: sp_weights::weight_v2::Weight
   **/
  ...
  /**
   * Lookup102: pallet_contracts::pallet::Call<T>
   **/
  PalletContractsCall: {
    _enum: {
      call_old_weight: {
  ...
  /**
   * Lookup104: pallet_contracts::wasm::Determinism
   **/
  PalletContractsWasmDeterminism: {
    _enum: ['Enforced', 'Relaxed']
  },
  /**
   * Lookup105: pallet_im_online::pallet::Call<T>
   **/
  PalletImOnlineCall: {
    _enum: {
      heartbeat: {
  ...
  /**
   * Lookup106: pallet_im_online::Heartbeat<BlockNumber>
   **/
  ...
  /**
   * Lookup107: sp_core::offchain::OpaqueNetworkState
   **/
  ...
  /**
   * Lookup111: pallet_im_online::sr25519::app_sr25519::Signature
   **/
  PalletImOnlineSr25519AppSr25519Signature: 'SpCoreSr25519Signature',
  /**
   * Lookup112: sp_core::sr25519::Signature
   **/
  SpCoreSr25519Signature: '[u8;64]',
  /**
   * Lookup113: pallet_session::pallet::Call<T>
   **/
  PalletSessionCall: {
    _enum: {
      set_keys: {
  ...
  /**
   * Lookup114: d9_node_runtime::opaque::SessionKeys
   **/
  ...
  /**
   * Lookup116: sp_authority_discovery::app::Public
   **/
  SpAuthorityDiscoveryAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup117: pallet_treasury::pallet::Call<T, I>
   **/
  PalletTreasuryCall: {
    _enum: {
      propose_spend: {
  ...
  /**
   * Lookup118: pallet_d9_council_lock::pallet::Call<T>
   **/
  PalletD9CouncilLockCall: {
    _enum: {
      set_pallet_admin: {
        newAdmin: 'AccountId32',
      },
      set_mining_pool_contract: {
        newContract: 'AccountId32',
      },
      propose_lock: {
        accountToLock: 'AccountId32',
        proposalFee: 'u128',
      },
      propose_unlock: {
        accountToUnlock: 'AccountId32',
        proposalFee: 'u128',
      },
      vote_in_referendum: {
        lockCandidate: 'AccountId32',
        assentOnDecision: 'bool',
      },
      set_proposal_fee: {
        newFee: 'u128',
      },
      admin_lock_accounts: {
        accountsToLock: 'Vec<AccountId32>',
        proposer: 'AccountId32',
      },
      admin_unlock_accounts: {
        accountsToUnlock: 'Vec<AccountId32>',
      },
      admin_remove_proposal: {
        proposedAccount: 'AccountId32'
      }
    }
  },
  /**
   * Lookup119: pallet_d9_multi_sig::pallet::Call<T>
   **/
  PalletD9MultiSigCall: {
    _enum: {
      create_multi_sig_account: {
        signatories: 'Vec<AccountId32>',
        authorsOpt: 'Option<Vec<AccountId32>>',
        minApprovingSignatories: 'u32',
      },
      author_a_call: {
      ...
      remove_call_approval: {
        multiSigAccount: 'AccountId32',
        callId: '[u8;32]',
      },
      proposal_msa_new_minimum: {
        msaAddress: 'AccountId32',
        newMinApprovals: 'u32',
      },
      approve_msa_new_minimum: {
        msaAddress: 'AccountId32',
      },
      revoke_approval_for_msa_new_minimum: {
        msaAddress: 'AccountId32',
      },
      remove_call: {
        multiSigAccount: 'AccountId32',
  ...
  /**
   * Lookup121: pallet_sudo::pallet::Event<T>
   **/
  PalletSudoEvent: {
    _enum: {
      Sudid: {
  ...
  /**
   * Lookup124: frame_system::AccountInfo<Index, pallet_d9_balances::types::AccountData<Balance>>
   **/
  ...
  /**
   * Lookup125: frame_support::dispatch::PerDispatchClass<sp_weights::weight_v2::Weight>
   **/
  ...
  /**
   * Lookup126: sp_runtime::generic::digest::Digest
   **/
  SpRuntimeDigest: {
    logs: 'Vec<SpRuntimeDigestDigestItem>'
  },
  /**
   * Lookup128: sp_runtime::generic::digest::DigestItem
   **/
  ...
  /**
   * Lookup130: frame_system::EventRecord<d9_node_runtime::RuntimeEvent, primitive_types::H256>
   **/
  ...
  /**
   * Lookup132: frame_system::pallet::Event<T>
   **/
  FrameSystemEvent: {
    _enum: {
      ExtrinsicSuccess: {
  ...
  /**
   * Lookup133: frame_support::dispatch::DispatchInfo
   **/
  ...
  /**
   * Lookup134: frame_support::dispatch::DispatchClass
   **/
  FrameSupportDispatchDispatchClass: {
    _enum: ['Normal', 'Operational', 'Mandatory']
  },
  /**
   * Lookup135: frame_support::dispatch::Pays
   **/
  FrameSupportDispatchPays: {
    _enum: ['Yes', 'No']
  },
  /**
   * Lookup136: pallet_transaction_payment::pallet::Event<T>
   **/
  ...
  /**
   * Lookup137: pallet_assets::pallet::Event<T, I>
   **/
  PalletAssetsEvent: {
    _enum: {
      Created: {
  ...
  /**
   * Lookup139: pallet_contracts::pallet::Event<T>
   **/
  ...
  /**
   * Lookup140: pallet_im_online::pallet::Event<T>
   **/
  PalletImOnlineEvent: {
    _enum: {
      HeartbeatReceived: {
      ...
      AllGood: 'Null',
      SomeOffline: {
        offline: 'Vec<(AccountId32,PalletD9NodeVotingValidatorVoteStats)>'
      }
    }
  },
  /**
   * Lookup143: pallet_session::pallet::Event
   **/
  PalletSessionEvent: {
    _enum: {
      NewSession: {
  ...
  /**
   * Lookup145: pallet_d9_council_lock::pallet::Event<T>
   **/
  PalletD9CouncilLockEvent: {
    _enum: {
      AccountNominatedForLock: 'AccountId32',
      ProposalFeePaid: '(AccountId32,u128)',
      VoteRecorded: '(AccountId32,AccountId32,PalletD9CouncilLockAccountLockState,bool)',
      AccountLocked: 'AccountId32',
      AccountUnlocked: 'AccountId32',
      AccountNominatedForUnlock: 'AccountId32',
      VoteStarted: 'Null',
      VoteEnded: '(AccountId32,PalletD9CouncilLockVoteResult)'
    }
  },
  /**
   * Lookup146: pallet_d9_council_lock::types::AccountLockState
   **/
  PalletD9CouncilLockAccountLockState: {
    _enum: ['Locked', 'Unlocked']
  },
  /**
   * Lookup147: pallet_d9_council_lock::types::VoteResult
   **/
  PalletD9CouncilLockVoteResult: {
    _enum: {
      Passed: 'Null',
      Rejected: 'Null',
  ...
  /**
   * Lookup148: pallet_d9_multi_sig::pallet::Event<T>
   **/
  PalletD9MultiSigEvent: {
    _enum: {
      MultiSignatureAccountCreated: '(AccountId32,AccountId32)',
      MultiSignatureAccountUpdated: '(AccountId32,AccountId32)',
      NewCallAuthored: '(AccountId32,[u8;32])',
      ApprovalAdded: '(AccountId32,AccountId32)',
      ApprovalRemoved: '(AccountId32,AccountId32)',
      CallExecuted: '[u8;32]',
      MinApprovalsChanged: '(AccountId32,u32)'
    }
  },
  /**
  ...
  /**
   * Lookup168: pallet_transaction_payment::Releases
   **/
  PalletTransactionPaymentReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup169: pallet_assets::types::AssetDetails<Balance, sp_core::crypto::AccountId32, DepositBalance>
   **/
  ...
  /**
   * Lookup170: pallet_assets::types::AssetStatus
   **/
  ...
  /**
   * Lookup176: pallet_assets::types::AssetMetadata<DepositBalance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup182: pallet_collective::Votes<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup183: pallet_collective::pallet::Error<T, I>
   **/
  PalletCollectiveError: {
    _enum: ['NotMember', 'DuplicateProposal', 'ProposalMissing', 'WrongIndex', 'DuplicateVote', 'AlreadyInitialized', 'TooEarly', 'TooManyProposals', 'WrongProposalWeight', 'WrongProposalLength']
  },
  /**
   * Lookup185: pallet_contracts::wasm::PrefabWasmModule<T>
   **/
  ...
  /**
   * Lookup187: pallet_contracts::wasm::OwnerInfo<T>
   **/
  ...
  /**
   * Lookup188: pallet_contracts::storage::ContractInfo<T>
   **/
  ...
  /**
   * Lookup190: pallet_contracts::storage::DeletionQueueManager<T>
   **/
  ...
  /**
   * Lookup191: pallet_contracts::schedule::Schedule<T>
   **/
  ...
  /**
   * Lookup192: pallet_contracts::schedule::Limits
   **/
  ...
  /**
   * Lookup193: pallet_contracts::schedule::InstructionWeights<T>
   **/
  ...
  /**
   * Lookup194: pallet_contracts::schedule::HostFnWeights<T>
   **/
  ...
  /**
   * Lookup195: pallet_contracts::pallet::Error<T>
   **/
  ...
  /**
   * Lookup200: pallet_im_online::BoundedOpaqueNetworkState<PeerIdEncodingLimit, MultiAddrEncodingLimit, AddressesLimit>
   **/
  ...
  /**
   * Lookup204: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
  ...
  /**
   * Lookup211: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
    _enum: ['InvalidProof', 'NoAssociatedValidatorId', 'DuplicatedKey', 'NoKeys', 'NoAccount']
  },
  /**
   * Lookup212: pallet_treasury::Proposal<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup217: pallet_d9_council_lock::types::Proposal<d9_node_runtime::Runtime>
   **/
  PalletD9CouncilLockProposal: {
    proposedAccount: 'AccountId32',
    sessionIndex: 'u32',
    nominator: 'AccountId32',
    changeTo: 'PalletD9CouncilLockAccountLockState',
    creationTime: 'u64',
    estimatedTimeToReferendum: 'Option<u64>'
  },
  /**
   * Lookup218: d9_node_runtime::Runtime
   **/
  D9NodeRuntimeRuntime: 'Null',
  /**
   * Lookup220: pallet_d9_council_lock::types::LockReferendum<T>
   **/
  PalletD9CouncilLockLockReferendum: {
    nominator: 'AccountId32',
    proposedAccount: 'AccountId32',
    indexOfProposal: 'u32',
    changeTo: 'PalletD9CouncilLockAccountLockState',
    assentingVoters: 'Vec<AccountId32>',
    dissentingVoters: 'Vec<AccountId32>',
    startTime: 'u64',
    estimatedEndTime: 'u64'
  },
  /**
   * Lookup223: pallet_d9_council_lock::types::Resolution<d9_node_runtime::Runtime>
   **/
  PalletD9CouncilLockResolution: {
    nominator: 'AccountId32',
    proposedAccount: 'AccountId32',
    indexOfProposal: 'u32',
    changedTo: 'PalletD9CouncilLockAccountLockState',
    assentingVoters: 'Vec<AccountId32>',
    dissentingVoters: 'Vec<AccountId32>',
    result: 'PalletD9CouncilLockVoteResult',
    endTime: 'u64'
  },
  /**
   * Lookup224: pallet_d9_council_lock::types::AccountLock<d9_node_runtime::Runtime>
   **/
  PalletD9CouncilLockAccountLock: {
    account: 'AccountId32',
    nominator: 'AccountId32',
    lockIndex: 'u32'
  },
  /**
   * Lookup225: pallet_d9_council_lock::pallet::Error<T>
   **/
  PalletD9CouncilLockError: {
    _enum: ['NotValidNominator', 'ProposalFeeInsufficient', 'MiningPoolContractNotSet', 'ErrorGettingRankedNodes', 'AccountAlreadyLocked', 'AccountNotLocked', 'ProposalAlreadyExists', 'AccountAlreadyInReferendum', 'AdminCannotBeNominated', 'LockCandidatesNotPermittedToInteract', 'LockedAccountsNotPermittedToInteract', 'LockedAccountCannotVote', 'ReferendumDoesNotExist', 'NotValidCouncilMember', 'ErrorCalculatingVotes', 'VoterAlreadyVoted']
  },
  /**
   * Lookup226: pallet_d9_multi_sig::types::multi_signature_account::MultiSignatureAccount<T>
   **/
  PalletD9MultiSigMultiSignatureAccount: {
    address: 'AccountId32',
    authors: 'Option<Vec<AccountId32>>',
    signatories: 'Vec<AccountId32>',
    minimumSignatories: 'u32',
    pendingCalls: 'Vec<PalletD9MultiSigPendingCall>'
  },
  /**
   * Lookup230: pallet_d9_multi_sig::types::pending_call::PendingCall<T>
   **/
  PalletD9MultiSigPendingCall: {
    id: '[u8;32]',
    call: 'Bytes',
    approvals: 'BTreeSet<AccountId32>'
  },
  /**
   * Lookup236: pallet_d9_multi_sig::types::min_approval_proposal::MinimumApprovalProposal<T>
   **/
  PalletD9MultiSigMinApprovalProposalMinimumApprovalProposal: {
    msaAddress: 'AccountId32',
    newMinimum: 'u32',
    proposer: 'AccountId32',
