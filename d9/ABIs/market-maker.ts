  ...
  spec: {
    ...
    messages: [
      ...
      },
      {
        args: [],
        default: false,
        docs: [" get pool balances (d9, usdt)"],
      ...
      },
      {
        ...
        default: false,
        docs: [" add liquidity by adding tokens to the reserves"],
        label: "add_liquidity",
        mutates: true,
        payable: true,
        returnType: {
      ...
      },
      {
        ...
        default: false,
        docs: [" calculate lp tokens based on usdt liquidity"],
      ...
      },
      {
        ...
        default: false,
        docs: [" amount of currency B from A, if A => B"],
      ...
      },
      {
        ...
        default: false,
        docs: [" check if usdt balance is sufficient for swap"],
  ...
  types: [
    ...
    },
    {
      ...
      type: {
        ...
        path: ["market_maker", "market_maker", "Error"],
      },
    },
    {
      id: 16,
      type: {
        ...
        path: ["market_maker", "market_maker", "Currency"],
      },
    },
    {
      id: 17,
    ...
    },
    {
      ...
      type: {
        ...
        path: ["market_maker", "market_maker", "Direction"],
      },
    },
    {
      id: 20,
    ...
    },
    {
      ...
      type: {
        ...
        path: ["d9_chain_extension", "D9ChainExtension"],
      },
    },
  ],
  version: "4",
