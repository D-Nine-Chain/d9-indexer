...
export type Message = Message_asset_commit | Message_asset_dispatch | Message_cancel_admin_transfer | Message_change_controller | Message_claim_admin | Message_generate_tx_id | Message_get_current_nonce | Message_get_last_transaction | Message_get_transaction | Message_relinquish_admin
