...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletD9NodeVotingCall extends Enum {
    ...
    readonly type: 'SubmitCandidacy' | 'AddVotingInterest' | 'DelegateVotes' | 'RemoveCandidacy' | 'TryRemoveVotesFromCandidate' | 'RedistributeVotes' | 'ChangeCandidateName' | 'ChangeCandidateSupporterShare';
  }

  /** @name SpWeightsWeightV2Weight (28) */
  interface SpWeightsWeightV2Weight extends Struct {
    readonly refTime: Compact<u64>;
    readonly proofSize: Compact<u64>;
  }

  /** @name PalletD9NodeVotingStructsValidatorDelegations (30) */
  interface PalletD9NodeVotingStructsValidatorDelegations extends Struct {
    readonly candidate: AccountId32;
    readonly votes: Compact<u64>;
  }

  /** @name PalletD9NodeVotingEvent (31) */
  ...
  /** @name PalletD9NodeVotingError (32) */
  ...
  /** @name PalletD9BalancesAccountData (33) */
  ...
  /** @name PalletD9BalancesBalanceLock (36) */
  ...
  /** @name PalletD9BalancesReasons (38) */
  ...
  /** @name PalletGrandpaStoredState (57) */
  ...
  /** @name PalletGrandpaStoredPendingChange (58) */
  ...
  /** @name SpConsensusGrandpaAppPublic (61) */
  interface SpConsensusGrandpaAppPublic extends SpCoreEd25519Public {}

  /** @name SpCoreEd25519Public (62) */
  interface SpCoreEd25519Public extends U8aFixed {}

  /** @name PalletGrandpaCall (66) */
  ...
  /** @name SpConsensusGrandpaEquivocationProof (67) */
  interface SpConsensusGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpConsensusGrandpaEquivocation;
  }

  /** @name SpConsensusGrandpaEquivocation (69) */
  ...
  /** @name FinalityGrandpaEquivocationPrevote (70) */
  ...
  /** @name FinalityGrandpaPrevote (71) */
  interface FinalityGrandpaPrevote extends Struct {
    readonly targetHash: H256;
    readonly targetNumber: u32;
  }

  /** @name SpConsensusGrandpaAppSignature (72) */
  interface SpConsensusGrandpaAppSignature extends SpCoreEd25519Signature {}

  /** @name SpCoreEd25519Signature (73) */
  interface SpCoreEd25519Signature extends U8aFixed {}

  /** @name FinalityGrandpaEquivocationPrecommit (76) */
  ...
  /** @name FinalityGrandpaPrecommit (77) */
  ...
  /** @name PalletMultisigMultisig (83) */
  ...
  /** @name PalletContractsWasmDeterminism (99) */
  ...
  /** @name PalletImOnlineHeartbeat (101) */
  ...
  /** @name SpCoreOffchainOpaqueNetworkState (102) */
  interface SpCoreOffchainOpaqueNetworkState extends Struct {
    readonly peerId: OpaquePeerId;
    readonly externalAddresses: Vec<OpaqueMultiaddr>;
  }

  /** @name PalletImOnlineSr25519AppSr25519Signature (106) */
  interface PalletImOnlineSr25519AppSr25519Signature extends SpCoreSr25519Signature {}

  /** @name SpCoreSr25519Signature (107) */
  ...
  /** @name D9NodeRuntimeOpaqueSessionKeys (109) */
  ...
  /** @name SpRuntimeDispatchError (117) */
  ...
  /** @name SpRuntimeModuleError (118) */
  interface SpRuntimeModuleError extends Struct {
    readonly index: u8;
    readonly error: U8aFixed;
  }

  /** @name SpRuntimeTokenError (120) */
  ...
  /** @name SpArithmeticArithmeticError (121) */
  ...
  /** @name SpRuntimeTransactionalError (122) */
  ...
  /** @name FrameSystemAccountInfo (126) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeight (127) */
  ...
  /** @name SpRuntimeDigest (128) */
  interface SpRuntimeDigest extends Struct {
    readonly logs: Vec<SpRuntimeDigestDigestItem>;
  }

  /** @name SpRuntimeDigestDigestItem (130) */
  ...
  /** @name FrameSystemEventRecord (132) */
  ...
  /** @name FrameSupportDispatchDispatchInfo (135) */
  ...
  /** @name FrameSupportDispatchDispatchClass (136) */
  ...
  /** @name FrameSupportDispatchPays (137) */
  ...
  /** @name PalletTransactionPaymentEvent (138) */
  ...
  /** @name PalletCollectiveEvent (140) */
  ...
  /** @name FrameSystemLimitsBlockWeights (152) */
  ...
  /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (153) */
  ...
  /** @name FrameSystemLimitsWeightsPerClass (154) */
  ...
  /** @name FrameSystemLimitsBlockLength (156) */
  interface FrameSystemLimitsBlockLength extends Struct {
    readonly max: FrameSupportDispatchPerDispatchClassU32;
  }

  /** @name FrameSupportDispatchPerDispatchClassU32 (157) */
  ...
  /** @name PalletTransactionPaymentReleases (165) */
  ...
  /** @name PalletAssetsAssetDetails (166) */
  ...
  /** @name PalletAssetsAssetStatus (167) */
  ...
  /** @name PalletAssetsAssetAccount (169) */
  ...
  /** @name PalletAssetsExistenceReason (170) */
  ...
  /** @name PalletAssetsApproval (172) */
  interface PalletAssetsApproval extends Struct {
    readonly amount: u128;
    readonly deposit: u128;
  }

  /** @name PalletAssetsAssetMetadata (173) */
  ...
  /** @name PalletContractsWasmPrefabWasmModule (182) */
  ...
  /** @name PalletContractsWasmOwnerInfo (184) */
  ...
  /** @name PalletContractsStorageContractInfo (185) */
  ...
  /** @name PalletContractsScheduleLimits (189) */
  ...
  /** @name PalletContractsScheduleInstructionWeights (190) */
  ...
  /** @name PalletContractsScheduleHostFnWeights (191) */
  ...
  /** @name PalletImOnlineBoundedOpaqueNetworkState (197) */
  interface PalletImOnlineBoundedOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineError (201) */
  ...
  /** @name PalletTreasuryProposal (209) */
  ...
  /** @name FrameSupportPalletId (213) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletTreasuryError (214) */
  ...
  /** @name SpRuntimeMultiSignature (216) */
  ...
  // /** @name FrameSystemExtensionsCheckNonZeroSender (220) */
  // type FrameSystemExtensionsCheckNonZeroSender = Null;

  // /** @name FrameSystemExtensionsCheckSpecVersion (221) */
  // type FrameSystemExtensionsCheckSpecVersion = Null;

  // /** @name FrameSystemExtensionsCheckTxVersion (222) */
  // type FrameSystemExtensionsCheckTxVersion = Null;

  // /** @name FrameSystemExtensionsCheckGenesis (223) */
  // type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (226) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  // /** @name FrameSystemExtensionsCheckWeight (227) */
  // type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentChargeTransactionPayment (228) */
  interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {}

  /** @name D9NodeRuntimeRuntime (229) */
