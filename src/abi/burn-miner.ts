...
export interface Account {
    ...
    balanceDue: Balance
    balancePaid: Balance
    lastWithdrawal?: (bigint | undefined)
    lastBurn: bigint
...
export interface Constructor_new {
    __kind: 'new'
    burnManagerContract: AccountId
    burnMinimum: Balance
}

export type Message = Message_get_account | Message_get_ancestors | Message_initiate_burn | Message_prepare_withdrawal
