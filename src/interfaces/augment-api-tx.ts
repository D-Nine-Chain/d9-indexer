...
import { SpWeightsWeightV2Weight, PalletContractsWasmDeterminism, PalletD9NodeVotingStructsValidatorDelegations, PalletD9NodeVotingStructsNodeMetadataStruct, SpConsensusGrandpaEquivocationProof, SpCoreVoid, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletMultisigTimepoint, D9NodeRuntimeOpaqueSessionKeys } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    d9NodeVoting: {
      addVotingInterest: AugmentedSubmittable<(beneficiaryVoter: AccountId32 | string | Uint8Array, mainPool: AccountId32 | string | Uint8Array, amountToBurn: u128 | AnyNumber | Uint8Array, burnContract: AccountId32 | string | Uint8Array, weight: SpWeightsWeightV2Weight | { refTime?: any; proofSize?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, u128, AccountId32, SpWeightsWeightV2Weight]>;
